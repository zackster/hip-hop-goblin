...
Hip Hop Goblin is Pandora for the newest hip hop. It helps artists get heard and gain fans. It helps listeners discover the latest underground real.
...
A quick* guide for people who've never used github:
    ...
    * fork it, make changes, commit changes, push those changes http://help.github.com/forking/
    * Submit pull request to Zackster
    * Success!
