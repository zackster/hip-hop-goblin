...
$_CONFIG['upload_dir']                            = '/home/devsquid/public_html/hiphopgoblin.com/temp/ubr/';                                                                   // Path to upload directory
$_CONFIG['max_upload_slots']                      = 5;                                                                                                            // Maximum number of files a user can upload at once
...
$_CONFIG['check_file_name_regex']                 = '^[\sa-zA-Z0-9\-\_]+[\sa-zA-Z0-9\-\_\.]+[a-zA-Z0-9\-\_]$';                                                        // Regex used on client side file name check
...
$_CONFIG['redirect_url']                          = 'http://'. $_SERVER['HTTP_HOST'] . '/upload/ubr_finished.php';                                                       // What page to load after the upload completes (only used if REDIRECT_METHOD ini setting is > 0)
...
$_CONFIG['allow_extensions']                      = '(mp3|mpg|mpeg)';                                                  // Include file extentions that are allowed to be uploaded
